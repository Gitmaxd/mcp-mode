...
import { ensureDir, nowIsoCompact, safeIdentifier, uniqueSafeToolMap, writeJson, getClaudeModeDataDir, serverNameToDirName } from "./util.mjs";
...
export function hydrateTools(opts) {
  ...
  const baseOut =
    opts.outDir ||
    path.join(getClaudeModeDataDir(), "hydrated", serverDir, ts);
